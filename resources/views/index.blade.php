...
<section class="pt-0 height-65" style="border-bottom: 3px solid white;">
    <div class="slider-animate home-slider">
        <div>
            <div class="home">
                <img src="./assets/images/_products/slider1.jpeg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
                                <div>
                                    <h4 class="animated" data-animation-in="fadeInUp">Economisez jusqu'à 30%</h4>
                                    <br>
                                    <h2 class="animated font-fraunces" data-animation-in="fadeInUp"
                                        data-delay-in="0.3" style="color: white;">
                                        La qualité des cheveux naturels</h2><a href="#" class="btn btn-solid animated"
                        ...
                        <div class="col">
                            <div class="slider-contain">
                                <div>
                                    ...
                                    <h2 class="animated font-fraunces" data-animation-in="fadeInUp"
                                        data-delay-in="0.3">
                                        Choisissez le meilleur</h2><a href="#" class="btn btn-solid animated"
                                        data-animation-in="fadeInUp" data-delay-in="0.5">Découvrir</a>
                                </div>
                            </div>
                        </div>
