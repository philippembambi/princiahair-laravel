...
<!-- Home slider -->
<section class="pt-0 height-65" style="border-bottom: 3px solid white;">
    <div class="slider-animate home-slider">
        <div>
            <div class="home">
                <img src="{{  asset('assets/images/_products/slider1.jpeg')  }}" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
                                <div>
                                    <h4 class="animated" data-animation-in="fadeInUp" style="color: white;">La qualité des cheeux naturels est maintenant disponible</h4>
                                    <br>
                                    <h2 class="animated font-fraunces" data-animation-in="fadeInUp"
                                        data-delay-in="0.3" style="color: white;">
                                        Princiahair illumine votre coiffure</h2><a href="{{  route('product.all')  }}" class="btn btn-solid animated"
                                        data-animation-in="fadeInUp" data-delay-in="0.5">Découvrir</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="service section-b-space bg-light">
            <div class="container">
                <div class="row partition4 ">
                    <div class="col-lg-3 col-md-6 service-block1">
                        ...
                        <p>Faites-nous confiance pour retirer votre produit depuis chez vous. </p>
                    </div>
                    <div class="col-lg-3 col-md-6 service-block1 ">
                        ...
                        <h4>24 X 7 Ouvrable</h4>
                        <p>Nos services sont à votre disponibilité à chaque seconde. </p>
                    </div>
                    <div class="col-lg-3 col-md-6 service-block1 border border-0">
                        ...
                        <h4>Top promo</h4>
                        <p>Recevez des nouvelles sur les nouvelles colletions en promotion. </p>
                    </div>
                    <div class="col-lg-3 col-md-6 service-block1 border border-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                        ...
                        <p>Vous pouvez payez par le moyen qui vous convient le plus. </p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <section class="p-0">
                <div class="full-banner parallax text-center p-left">
                    <img src="./assets/images/_products/banner6.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                            ...
                            <div class="col-12">
                                <div class="modal-bg">
                                    ...
                                    <div class="offer-content"> <img src="../assets/images/Offer-banner.png"
                                        ...
                                        <h2 style="font-size: 20px;">Acheter sur code promo</h2>
                                        <form
