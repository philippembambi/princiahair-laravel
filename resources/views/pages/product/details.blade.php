...
@section('content')
                            ...
                            <div class="row">
                                <div class="col-12 p-0">
                                    <div class="slider-nav">
                                        <div><img src="./assets/images/_products/11.jpg" alt=""
                                                class="img-fluid blur-up lazyload"></div>
                                        <div><img src="./assets/images/_products/8.jpg" alt=""
                                                class="img-fluid blur-up lazyload"></div>
                                        <div><img src="./assets/images/_products/3.webp" alt=""
                                                class="img-fluid blur-up lazyload"></div>
                                        <div><img src="./assets/images/_products/11.jpg" alt=""
                                                class="img-fluid blur-up lazyload"></div>
                                    </div>
    ...
    @component('components.related_product')
    @endcomponent
