...
<header>
    ...
    <div class="top-header" style="background-color: #394868;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6 text-end">
                    <ul class="header-dropdown">
                        <li style="color: white;" class="mobile-wishlist"><a href="#"><i class="fa fa-heart" aria-hidden="true"></i></a>
                        </li>
                        <li style="color: white;" class="onhover-dropdown mobile-account" style="color: white;"> <i class="fa fa-user" aria-hidden="true"></i>
                            Mon compte
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="./details.html">no sidebar</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li>
