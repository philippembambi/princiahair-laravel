...
<div class="page-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 p-0 card-left">
                    <div class="card bg-primary" style="height: 460px;">
                        <div class="svg-icon">
    ...
    c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z" />
                        ...
                        <div class="single-item">
                            <div>
                                <div>
                                    <h3>Admin PrinciaHair</h3>
                                    <p>
                                        Bienvenu dans l'espace d'administration princiahair, vous devez vous authentifier pour accéder à cet espace d'administration
                                    </p>
                                </div>
                            </div>
                        </div>
                                       ...
                                       @csrf
                                        <div class="form-group">
                                            <input required="" name="email" type="email"
                                                class="form-control" placeholder="Adresse e-mail" id="exampleInputEmail1">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-terms">
                                            <div class="form-check mesm-2">
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="btn btn-default forgot-pass">Mot de passe oublié ?</a>
                                            </div>
                                        </div>
